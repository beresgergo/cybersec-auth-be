...
const authenticationSession = require('../models/sessionStore');
...
module.exports.populateSession = (req, res, next) => {
    ...
    authenticationSession.findOne({ id: req.body.sessionId }, (_, result) => {
        if (result) {
...
module.exports.removeSession = (req, res, next) => {
    ...
    authenticationSession
        ...
        .then((_) => {
            authenticationSession.deleteOne({ id: req.body.sessionId }, next);
        });
};
