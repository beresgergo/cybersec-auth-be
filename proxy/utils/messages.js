...
module.exports.SIGNATURE_INVALID_ENCODING = 'Signature should be base64 encoded.';
module.exports.SIGNATURE_INVALID_LENGTH = 'Signature length mismatch.';
module.exports.SESSION_INVALID = 'SessionId is not in valid format.';
module.exports.SIGNED_CHALLENGE_EMPTY = 'Signed challenge field is mandatory.';
